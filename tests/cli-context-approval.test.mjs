...
`;
    ...
    assert.equal(
      initialCommit.code,
      0,
      initialCommit.stderr || initialCommit.stdout
    );
    ...
    assert.equal(
      startContext.code,
      0,
      startContext.stderr || startContext.stdout
    );
    ...
    const finishContext = await runCli(dir, [
      'context',
      'F001-alpha',
      '--json',
    ]);
    assert.equal(
      finishContext.code,
      0,
      finishContext.stderr || finishContext.stdout
    );
